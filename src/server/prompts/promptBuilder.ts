  ...
  if (settingParts.length > 0) {
    parts.push(
      [
        ...
        '現在の場面に影響する内容と、舞台の質感を自然に深める内容だけを必要な範囲で反映し、設定を示すためだけの説明・会話・描写を足さない。',
...
function renderKnowledgeTexts(
  ...
  return [
    ...
    '本文で紹介する資料ではなく、現在の場面に必要な設定・用語・事実関係を確認するための背景情報として使うこと。',
    '資料が渡されているという理由だけで内容を本文に持ち込まず、説明文や箇条書きを要約・言い換えして転載しないこと。',
